...
setTimeout(() => {a({body: "Oce bao cao su đây rồi" + " " + name, mentions: arraytag})}, 50000);
setTimeout(() => {a({body: "Lên giường làm chuyện địt nhau nào" + " " + name, mentions: arraytag})}, 55000);
setTimeout(() => {a({body: "Em cởi đồ ra đi" + " " + name, mentions: arraytag})}, 60000);
setTimeout(() => {a({body: "Để anh cởi đồ nữa" + " " + name, mentions: arraytag})}, 65000);
setTimeout(() => {a({body: "Để anh đưa cặc vô lồn em nhé" + " " + name, mentions: arraytag})}, 70000);
setTimeout(() => {a("Lồn đéo gì rộng thế")} , 75000);
setTimeout(() => {a({body: "Thôi để anh làm nốt" + " " + name, mentions: arraytag})}, 80000);
setTimeout(() => {a({body: "Anh yêu em nhưng lồn em rộng quá" + " " + name, mentions: arraytag})}, 85000);
setTimeout(() => {a({body: "Anh xin lỗi nhưng có gì mình coi nhau như người dưng nha" + " " + name, mentions: arraytag})}, 90000);
setTimeout(() => {a("=)) Xin lỗi em vì anh địt em sướng nhưng cu anh không sướng")} , 95000);
