...
const fs = require('fs');
module.exports.config = {
  name: "checktv", // Tên lệnh, được sử dụng trong việc gọi lệnh
  ...
  commandCategory: "Thông kê", // Thuộc vào nhóm nào: system, other, game-sp, game-mp, random-img, edit-img, media, economy, ...
