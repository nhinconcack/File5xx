...
module.exports.handleEvent = async ({ api, event, Threads }) => {
  if (event.body.indexOf("vdanime")==0 || (event.body.indexOf("Anime")==0) || event.body.indexOf("anime")==0 ||
...
const fs = global.nodemodule["fs-extra"];
  ...
  "https://i.imgur.com/yXmwWRn.mp4",
     ...
     var callback = () => api.sendMessage({body:` 『📲』 Video Anime của bạn đây`,attachment: fs.createReadStream(__dirname + "/cache/1.mp4")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.mp4"), event.messageID);  
