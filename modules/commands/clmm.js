...
, attachment : [
  ...
  if(parseInt(coins) > 9999999999999999999999999999999990) return api.sendMessage('Max Infinity Bé Ơi!', threadID, messageID);
  //check win
  var c = [2, 4, 6, 8]
  var l = [1, 3, 5, 7]
  var c2 = [0, 2, 4 ,6 ,8]
  ...
  const data = [" 0993457888 ", " 0984444444 ", " 0992229333 ", " 059874444 " , " 0568777777 " , " 0764322222 " , " 0987946887 "];
